...
echo "make CONFIG=$CONFIG_NAME run-binary-hex BINARY=$TEST_BINARY BINARY_ARGS=$PK_ARG -j24"
make CONFIG=$CONFIG_NAME run-binary-hex BINARY=$TEST_BINARY  BINARY_ARGS=$PK_ARG -j24
